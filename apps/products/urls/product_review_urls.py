...
from apps.products.views.product_review_views import product_review_view,product_create_reviews,product_delete_reviews,product_form_update_reviews,product_table_reviews_results,product_update_reviews
...
urlpatterns = [
    ...
    path('product_update_reviews/<int:pk>/',product_update_reviews,name='product_update_reviews'),
